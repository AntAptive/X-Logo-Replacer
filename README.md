...
Please note that this GitHub repo contains the original files to the extension. Most browsers have security in place that may block this extension.
***The extension does nothing malicious. All source code for the extension is in this repo.***
